"""
Run from C:\MLB:
    python data/restore_backtest.py

Writes the complete correct backtest.py directly to data/backtest.py
"""
import os
...
out = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'backtest.py')
with open(out, 'w', encoding='utf-8') as f:
    f.write(BACKTEST)
print(f"✅ Restored backtest.py ({len(BACKTEST):,} chars)")
print(f"   Location: {out}")
print("   Run: python data/backtest.py")
